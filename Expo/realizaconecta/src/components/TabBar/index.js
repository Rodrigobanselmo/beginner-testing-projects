...
export default ({ state, navigation }) => {
  ...
  return (
    <ContainerTabArea style={styles.TabArea}>  
      ...
      <TouchableOpacity onPress={()=>goTo('Teste')} style={styles.TabItem} >
        <Ionicons name="grid" color={themeContext.colors.primary.main} size={23} style={{opacity: state.index===2? 1 : 0.5}} />
      </TouchableOpacity>
    </ContainerTabArea>
  );
}
