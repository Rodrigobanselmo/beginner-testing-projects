...
//(row,data,selected,handleClick,handleCellClick,styleCell)
export const Row = React.memo((
    { index, style, data: { selected,handleClick,handleCellClick,styleCell,data,items } }
) => {
...
export const LoadingContent = React.memo(() => {
