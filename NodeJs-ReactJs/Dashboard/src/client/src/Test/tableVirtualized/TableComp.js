...
export default function EnhancedTable({
  ...
  const createItemData = memoize((selected,handleClick,handleCellClick,styleCell, data) => ({
    selected:selected,
    handleClick,
    handleCellClick,
    styleCell,
  ...
  const itemData = createItemData(selected,handleClick,handleCellClick?handleCellClick:handleClick,styleCell, data);
  return (
