...
export default function EnhancedTable({
  ...
  return (
    <div className={classes.root}>
        <TableContainerComponent component="div">
            <TableComponent
            ...
            />
            <TableBodyComponent component="div">
            <AutoSizer>
              {({ height, width }) => (
                <List
                  ...
                  itemData={data.rows}
                >
                  {({index,style,data:row})=>rowComponent(row[index],data,selected,handleClick,handleCellClick?handleCellClick:handleClick,styleCell)}
                </List>
              )}
            </AutoSizer>
 {/*                {stableSort(data.rows, getComparator(order, orderBy))
                .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                .map((row,index)=>rowComponent(row,data,selected,handleClick,handleCellClick?handleCellClick:handleClick,styleCell))}
