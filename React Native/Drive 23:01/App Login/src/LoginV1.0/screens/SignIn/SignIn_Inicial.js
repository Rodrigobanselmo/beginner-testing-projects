...
export default function App({navigation}) {
  return (
    <SafeAreaView style={{flex:1,alignItems:`center`,justifyContent:`flex-start`}} >
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('SignIn_Register_1')} style={[styles.button,{marginBottom:20}]}>
        <Text style={{fontSize:20,letterSpacing:2}} >REGISTRAR</Text>
      </TouchableOpacity>

      <Text style={{fontSize:13,marginBottom:5}} >Tem uma conta Gamma?</Text>

      <TouchableOpacity onPress={()=>navigation.navigate('SignIn_Conect_1')} style={[styles.button,{marginBottom:15}]}>
