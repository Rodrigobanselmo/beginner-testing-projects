            ...
            return (
                <View style={styles.right}>
                    ...
                    <TouchableOpacity style={{paddingRight: 28}}  onPress={openRightpause} >
                        <Ionicons  name="play" size={22} color={colors.editPausar} />
                    </TouchableOpacity>
                    }
                    <TouchableOpacity style={{paddingRight: 26/* , backgroundColor: 'red' */}}  onPress={openRightnotdone} >
                    <Ionicons  name="ios-close-sharp" size={22} color={colors.closeList} />
                    </TouchableOpacity>
                ...
                :        
                    information == 2 ?              
                        <Animated.View style={[styles.left, {marginVertical: rowHeightAnimatedValue, paddingLeft:10}]} >
                            <Animated.View style={[styles.leftInside,{marginRight:open ? 0 : 30, borderTopLeftRadius:10, borderBottomLeftRadius:10}]} backgroundColor={colors.carbonLight}>
                    ...
                    :
                        information == 1 ? 
                            <Animated.View style={[styles.left, {marginVertical: rowHeightAnimatedValue, paddingLeft:13}]} >
...
/*         setisOpen(true) */
    ...
    return (
        ...
        <View style={[styles.All]}>
            <TouchableOpacity activeOpacity={0.7} onPress={()=>onDoublePress()} /* onPress={()=>onPress(index)} */>
            <LinearGradient colors={[data.backgroundColor[0],data.backgroundColor[1]]} style={[styles.TouchableHighlight]} >
                    <View style={styles.View_Box}>
                        ...
                        <TouchableOpacity style={styles.Graph_View} >
                            ...
                            :    
                            <View style={styles.loading}><Text style={styles.loadingText}>{`${Math.round(data.progress*100)}%`}</Text></View>                      
                        }
