            ...
            options={{
                headerLeft: () => (
                    <TouchableOpacity style={{marginLeft:20}} onPress={() => navigation.openDrawer()}>
                        <Ionicons name="ios-menu" color={colors.IconActivi} size={30} > </Ionicons>
                    </TouchableOpacity>
                ),
                headerRight: () => (
                    <TouchableOpacity style={{marginRight:20,flexDirection:'row'}} onPress={() => navigation.openDrawer()}>
                        <View style={{justifyContent:'center',alignItems:'center', marginRight:15}} >
                            <Entypo name="share" color={colors.IconActivi} size={22} > </Entypo>
                        </View>

                        <View style={{justifyContent:'center',alignItems:'center', marginRight:15}} >
                            <Vetor width="20" height="20" fill={colors.IconActivi}/>
                        </View>

                        <View style={{justifyContent:'center',alignItems:'center'}} >
                            <Entypo name="dots-three-vertical" color={colors.IconActivi} size={20} > </Entypo>
                        </View>
                    </TouchableOpacity>
                ),
...
/*                 headerBackground: props => <View backgroundColor='rgba(245, 245, 247, 1)' flex={1} />, */
                headerBackground: props => <View backgroundColor={colors.backgroundheader} flex={1} />,
