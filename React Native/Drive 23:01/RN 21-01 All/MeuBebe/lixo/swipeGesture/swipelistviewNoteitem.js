...
export default ({ data, index, naofinalizada,pausar,concluirTarefa, colors }) => {
        ...
        const getRightContent = () => {
            return (
                <View style={styles.right}>
                    {data.para < new Date() ?
                    <TouchableOpacity style={{paddingRight: 16}}  onPress={openRight} >
                        <Ionicons  name="ios-calendar-sharp" size={22} color={colors.carbon} />
                    </TouchableOpacity>
                        :
                    <TouchableOpacity style={{paddingRight: 16}}  onPress={openRightpause} >
                        <Ionicons  name="play" size={22} color={colors.carbon} />
                    </TouchableOpacity>
                    }
                    <TouchableOpacity style={{paddingRight: 14}}  onPress={openRightnotdone} >
        ...
        const getLeftContent = (progress,dragX) => {
            ...
            return (
                ...
                :        
                    information == 2 ?              
                        <Animated.View style={[styles.left, {marginVertical: rowHeightAnimatedValue}]} >
                            <Animated.View style={[styles.leftInside,{marginRight:open ? 0 : 30}]} backgroundColor={colors.carbonLight}>
                    ...
                    :
                        information == 1 ? 
                            <Animated.View style={[styles.left, {marginVertical: rowHeightAnimatedValue}]} >
                                <Animated.View style={[styles.leftInside,{marginRight:open ? 0 : 30}]} backgroundColor={colors.greenLight}>
                                <Animated.View style={[{paddingHorizontal:25},{transform: [{ scale: trans}]}]} >
                        ...
                        :
                            <Animated.View style={[styles.left, {marginVertical: rowHeightAnimatedValue}]} >
                                <Animated.View style={[styles.leftInside,{marginRight:open ? 0 : 30}]} backgroundColor={colors.notLight}>
                                <Animated.View style={[{paddingHorizontal:25},{transform: [{ scale: trans}]}]} >
