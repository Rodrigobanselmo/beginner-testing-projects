...
{/*                     <MaterialCommunityIcons  name="anchor" size={20} color={colors.Ancora} /> */}
    ...
    return (
        ...
        <View flex={1} style={[styles.square]} marginHorizontal={0}>
            <LinearGradient style={[styles.square,styles.TouchableHighlight,{marginHorizontal:screenWidth*0.025}, {shadowColor:colors.Add_buttonShadow || '#000'}]}  colors={[colors.Box1 || '#000',colors.Box2 || '#000']} >
