      ...
      <View style={styles.container}>
          ...
          <View style={{alignItems:'center', backgroundColor:'transparent'}}>
            <View style={{marginLeft:15, marginBottom:3, marginRight:6, height: 79, width:79, borderRadius:50, borderWidth:1, borderColor:'#037F8C', justifyContent:'center',alignItems:'center'}}>
              <View style={{backgroundColor:'#262626', height: 69, width:69, borderRadius:50, borderWidth:1, borderColor:'#04D9B2', justifyContent:'center',alignItems:'center'}}>
                <MaterialCommunityIcons name="crown" size={45} backgroundColor="#121212" color='#04D9B2' />
              </View>
            </View>
          ...
          <View style={{alignItems:'center', backgroundColor:'transparent'}}>
            <View style={{ marginHorizontal:6, marginBottom:5, height: 79, width:79, borderRadius:50, borderWidth:1, borderColor:'#037F8C', justifyContent:'center',alignItems:'center'}}>
              <View style={{backgroundColor:'#262626', height: 69, width:69, borderRadius:50, borderWidth:1, borderColor:'#04D9B2', justifyContent:'center',alignItems:'center'}}>
              <FontAwesome5 name="money-check-alt" size={33} backgroundColor="#121212" color='#04D9B2' />
              </View>
            </View>
          ...
          <View style={{alignItems:'center', backgroundColor:'transparent'}}>
            <View style={{ marginHorizontal:6, marginBottom:5, height: 79, width:79, borderRadius:50, borderWidth:1, borderColor:'#037F8C', justifyContent:'center',alignItems:'center'}}>
              <View style={{backgroundColor:'#262626', height: 69, width:69, borderRadius:50, borderWidth:1, borderColor:'#04D9B2', justifyContent:'center',alignItems:'center'}}>
                <FontAwesome5 name="laptop-code" size={33} backgroundColor="#121212" color='#04D9B2' />
              </View>
            </View>
          ...
          <View style={{alignItems:'center', backgroundColor:'transparent'}}>
            <View style={{marginHorizontal:6, marginBottom:5, height: 79, width:79, borderRadius:50, borderWidth:1, borderColor:'#037F8C', justifyContent:'center',alignItems:'center'}}>
              <View style={{backgroundColor:'#262626', height: 69, width:69, borderRadius:50, borderWidth:1, borderColor:'#04D9B2', justifyContent:'center',alignItems:'center'}}>
                <SvgMARK fill='#04D9B2'  width="45" height="45" />
              </View>
            </View>
          ...
          <View style={{alignItems:'center', backgroundColor:'transparent'}}>
            <View style={{marginHorizontal:10, marginBottom:5, height: 79, width:79, borderRadius:50, borderWidth:1, borderColor:'#037F8C', justifyContent:'center',alignItems:'center'}}>
              <View style={{backgroundColor:'#262626', height: 69, width:69, borderRadius:50, borderWidth:3, borderColor:'#262626', justifyContent:'center',alignItems:'center'}}>
                <Ionicons name="people" size={37} backgroundColor="#121212" color='#04D9B2' />
              </View>
            </View>
